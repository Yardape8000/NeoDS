...
{
	NeoRom::getCurrent()->setProtection(NEOPROT_FATFURY2);
...
{
	NeoRom::getCurrent()->setProtection(NEOPROT_KOF98);
...
{
	NeoRom::getCurrent()->setProtection(NEOPROT_KOF99);
...
{
	NeoRom::getCurrent()->setProtection(NEOPROT_GAROU);
...
{
	NeoRom::getCurrent()->setProtection(NEOPROT_GAROUO);
...
{
	NeoRom::getCurrent()->setProtection(NEOPROT_KOF2000);
...
{
	NeoRom::getCurrent()->setProtection(NEOPROT_PVC);
